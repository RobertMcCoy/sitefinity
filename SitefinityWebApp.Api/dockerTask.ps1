...
.PARAMETER Clean
Removes the image sitefinitywebapp.api and kills all containers based on that image.
...
Build a Docker image named sitefinitywebapp.api
#>
...
$imageName="sitefinitywebapp.api"
$projectName="sitefinitywebappapi"
$serviceName="sitefinitywebapp.api"
